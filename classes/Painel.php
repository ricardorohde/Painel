		...
		public static function carregarPagina(){
			if(isset($_GET['url'])){
				...
				if(file_exists('pages/'.$url[0].'.php')){
					...
					//Sistema de rotas!					
					if(Router::get('visualizar-empreendimentos/?',function($par){
						include('views/visualizar-empreendimentos.php');
					})){

					}else if(Router::post('visualizar-empreendimentos/?',function($par){
						include('views/visualizar-empreendimentos.php');
					})){
					}else{
						header('Location: '.INCLUDE_PATH_PAINEL);
