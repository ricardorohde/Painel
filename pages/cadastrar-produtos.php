<div class="box-content">
	...
	<h2><i class="fas fa-box"></i> Cadastrar Produto</h2>
	<form method="post" enctype="multipart/form-data">
		...
		if(isset($_POST['acao'])){
			...
			if($sucesso){
				...
				$sql = MySql::conectar()->prepare("INSERT INTO `admin_estoque` VALUES (null,?,?,?,?,?,?,?)");
				$sql->execute(array($nome,$descricao,$largura,$altura,$comprimento,$peso,$quantidade));
				$lastId = MySql::conectar()->lastInsertId();
				foreach ($imagens as $key => $value) {
					MySql::conectar()->exec("INSERT INTO `admin.estoque_imagens` VALUES (null,$lastId,'$value')");
				}
		...
		<div class="form-group">
			...
			<input type="number" name="largura" min="0" max="900" step="any" value="0">
		</div><!--form-group-->

		<div class="form-group">
			<label>Altura do produto:</label>
			<input type="number" name="altura" min="0" max="900" step="any" value="0">
		</div><!--form-group-->

		<div class="form-group">
			<label>Comprimento do produto:</label>
			<input type="number" name="comprimento" min="0" max="900" step="any" value="0">
		</div><!--form-group-->

		<div class="form-group">
			<label>Peso do produto:</label>
			<input type="number" name="peso" min="0" max="900" step="any" value="0">
		</div><!--form-group-->
